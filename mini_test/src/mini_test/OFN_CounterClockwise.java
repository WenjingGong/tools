...
public class OFN_CounterClockwise extends FeatureIm{
	...
	public static void serialcomm(String num, long waittime){
		try {
			...
			Thread.sleep(500);
			System.out.println("The OFN Counterclockwise test is going to start:");
...
//			downloadfile.delete();
		...
		try {
			...
			bw.write("OFN_CounterClockwise_Result="+result+"\r\n");
			System.out.println("OFN_CounterClockwise_Result="+result);
