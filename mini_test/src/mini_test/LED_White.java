...
public class LED_White extends FeatureIm{
	...
	public static String serialcomm(String num, Scanner scanner){
		...
		try {
			...
			print(edit,"/usr/lib/leeonl/sensors/led_white.sh");
			Thread.sleep(500);
			System.out.println("Please enter the result of white LED light: p=pass, f=failed: ");
