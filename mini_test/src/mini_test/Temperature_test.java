...
public class Temperature_test extends FeatureIm{
	...
	public static boolean fileprocess(String downloadpath, String filepath, String []paras, String sn){
		...
		try {
			...
			bw.write("Temperature="+value+"\r\n");
			System.out.println("Temperature="+value);
			bw.write("Temperature_Result="+result+"\r\n");
			System.out.println("Temperature_Result="+result);
