...
public class Reset_Release extends FeatureIm{
	...
	public static void serialcomm(String num){
		try {
			...
			Thread.sleep(500);
			print(edit,"./reset-button.sh > reset_detec_release.txt");
			Thread.sleep(500);
			print(edit,"sz reset_detec_release.txt");
			Thread.sleep(2000);
			print(edit,"rm reset_detec_release.txt");
			Thread.sleep(500);
		} catch (Exception e) {
			e.printStackTrace();
		} 
	...
	public static boolean fileprocess(String downloadpath, String filepath){
		...
		File downloadfile1 = new File(downloadpath+"\\reset_detec_release.txt");
		...
		try {
			...
			bw.write("Reset_Release_Result="+result+"\r\n");
			System.out.println("Reset_Release_Result="+result);
