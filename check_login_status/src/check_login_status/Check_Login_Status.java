...
public class Check_Login_Status extends FeatureIm{
	...
	public static void main(String []args){
		...
		try{
			...
			print(edit,"/usr/lib/leeoalpha/sensors/led_off.sh");
			Thread.sleep(200);
			print(edit,"/usr/lib/leeoalpha/sensors/led_green.sh");
		}catch (Exception ex){
			ex.printStackTrace();
		}
	}
